directory = "/gv0/Users/achihwan/SKNanoRunlog/out/LRSM_TBChannel_test/2023BPix"
...
class SignalBackgroundCanvas():
    ...
    def draw(self):
        ...
        latex.DrawLatex(0.73, 0.93, "9.451 fb^{-1} (13.6 TeV)")  # Moved from 0.70, 0.91 to 0.65, 0.95
...
def plot_individual_mass_points():
    ...
    data_directory = "/gv0/Users/achihwan/SKNanoRunlog/out/LRSM_TBChannel_test/2023BPix"
